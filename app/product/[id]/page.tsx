...
import ProductGallery from "../../components/productPageComponents/ProductGallery";
...
import AddToCartButton from "../../components/productPageComponents/AddToCartButton";
...
const ProductPage = ({ params }: ProductPageProps) => {
  ...
  const handleAddToCart = () => {
    console.log(
      `Adicionando ${quantity} unidade(s) do produto ${id} ao carrinho`
    );
  };
